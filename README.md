...
* You could train Mask R-CNN on your own dataset. You could start the training from the pre-trained models (please see [synthia.py](https://github.com/jytime/Mask_RCNN_Pytorch/blob/master/synthia.py)).
